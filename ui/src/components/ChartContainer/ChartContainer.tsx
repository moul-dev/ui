        ...
        {visibleItems.map((item, idx) => (
          <div key={idx} {...stylex.props(styles.legendItem)}>
            <span
              ...
              style={{
                backgroundColor: item.color || 'var(--colorNeutral500)',
              }}
            />
  ...
  return (
    ...
    >
      <div
        {...stylex.props(
          styles.header,
          edgeToEdge && styles.headerEdgeToEdge,
          (showHeaderDivider || edgeToEdge) && styles.headerDivider,
        )}
      >
        <div>
      ...
      <div {...stylex.props(styles.body, edgeToEdge && styles.bodyEdgeToEdge)}>
        {loading && (
