...
The tertiary variant renders a premium sliding rounded pill background enclosed in a clean border surrounding the tabs, with subtle container track styling inspired by modern segmented controls and developer CLI interfaces.

<ComponentPreview>
  <Tabs variant="tertiary" defaultValue="pnpm">
    ...
    <TabPanels>
      <TabPanel id="pnpm">pnpm add @moul-dev/ui</TabPanel>
      <TabPanel id="yarn">yarn add @moul-dev/ui</TabPanel>
      <TabPanel id="bun">bun add @moul-dev/ui</TabPanel>
      <TabPanel id="npm">npm i @moul-dev/ui</TabPanel>
    </TabPanels>
  </Tabs>
</ComponentPreview>
