  ...
  return (
    <>
      <OpenGraph
        title={
          isKm
            ? 'Moul UI — រចនាឡើងសម្រាប់ភាពរលូន ផ្ចិតផ្ចង់ដើម្បីភាពរីកចម្រើន'
            : 'Moul UI — Engineered for flow. Crafted to scale.'
        }
        description={
          isKm
            ? 'ស្វែងយល់ពី Moul UI — បណ្ណាល័យសមាសភាគ React ដែលផ្ដល់ភាពងាយស្រួលប្រើប្រាស់ (Accessible) និងគ្មានបន្ទុក runtime (Zero-runtime) បង្កើតឡើងដោយ React Aria និង StyleX។'
            : 'Meet Moul UI. The UI library forged for moul.dev, engineered for your next big idea. Accessible, zero-runtime React components built with React Aria and StyleX.'
        }
            ...
            <div className="lg:col-span-7 flex flex-col items-center lg:items-start text-center lg:text-left">
              ...
              <h1 className="text-4xl font-extrabold tracking-tight sm:text-6xl max-w-3xl mx-auto lg:mx-0 leading-[1.3] mb-6">
                <span className="block text-fd-foreground">
                  {isKm ? 'រចនាឡើងសម្រាប់ភាពរលូន' : 'Engineered for flow.'}
                </span>
                <span
                ...
                >
                  {isKm ? 'ផ្ចិតផ្ចង់ដើម្បីភាពរីកចម្រើន' : 'Crafted to scale.'}
                </span>
              </h1>
              ...
              <p className="text-lg leading-8 text-fd-muted-foreground max-w-2xl mx-auto lg:mx-0 mb-8">
                {isKm ? (
                  <>
                    បណ្ណាល័យសមាសភាគ React បង្កើតឡើងដោយរួមបញ្ចូល{' '}
                    ...
                    ។ ផ្ដល់ជូននូវភាពងាយស្រួលប្រើប្រាស់ (Accessible) គ្មានបន្ទុក runtime
                    (Zero-runtime) និងឆ្លងកាត់ការប្រើប្រាស់ជាក់ស្ដែងលើប្រព័ន្ធផលិតកម្មនៅ{' '}
                    <a
                      href="https://moul.dev"
                      target="_blank"
        ...
        <div className="relative isolate px-6 overflow-hidden">
          <div className="mx-auto max-w-5xl w-full pb-20 sm:pb-28">
            <div className="border-t border-fd-border/30 pt-16 sm:pt-20">
              ...
              >
                {isKm ? 'ហេតុអ្វីជ្រើសរើស Moul UI' : 'Why Moul UI'}
              </p>
              <h2 className="text-3xl font-bold tracking-tight text-fd-foreground text-center mb-4">
                {isKm ? 'រចនាសម្ព័ន្ធខុសប្លែកពីគេ' : 'Built different.'}
              </h2>
              <p className="text-base text-fd-muted-foreground max-w-2xl mx-auto text-center mb-14 leading-relaxed">
                {isKm
                  ? 'ផ្ដល់ជូននូវបទពិសោធន៍អភិវឌ្ឍន៍ដ៏រលូននៃបណ្ណាល័យសមាសភាគកម្រិតខ្ពស់ រួមជាមួយនឹងល្បឿន និងភាពងាយស្រួលប្រើប្រាស់នៃដំណោះស្រាយដែលបង្កើតឡើងដោយផ្ទាល់ដៃ។'
                  : 'The developer experience of a premium component library with the performance and accessibility of a custom-built solution.'}
              </p>
              ...
              <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                ...
                <LiquidGlassCard className="feature-card">
                  ...
                  <div>
                    <h3 className="font-semibold text-base text-fd-foreground mb-1.5">
                      {isKm
                        ? 'ងាយស្រួលប្រើប្រាស់ជាចម្បង (Accessible by default)'
                    ...
                    <p className="text-sm text-fd-muted-foreground leading-relaxed">
                      {isKm ? (
                        <>
                          ...
                          ។ គាំទ្រការបញ្ជាតាមក្ដារចុចពេញលេញ កម្មវិធីអានអេក្រង់ (Screen
                          Reader) និង interaction states យ៉ាងរលូនតាំងពីដំបូង។
                        </>
                      ) : (
                        <>
                          Powered by{' '}
                ...
                <LiquidGlassCard className="feature-card">
                  ...
                  <div>
                    <h3 className="font-semibold text-base text-fd-foreground mb-1.5">
                      {isKm
                        ? 'គ្មានបន្ទុកពេលដំណើរការ (Zero-runtime)'
                    ...
                    <p className="text-sm text-fd-muted-foreground leading-relaxed">
                      {isKm ? (
                        <>
                          ...
                          ។ កូដ Atomic CSS ត្រូវបាន compile និងស្រង់ចេញនៅពេល build
                          ជាមួយសុវត្ថិភាពប្រភេទកូដ (Type-safety) ខ្ពស់
                          ដោយមិនបង្កការប៉ះទង្គិចឈ្មោះ និងគ្មានបន្ទុក JavaScript នៅពេល
                          runtime ឡើយ។
                        </>
                      ) : (
                        <>
                          ...
                          . Type-safe, collision-free atomic CSS extracted at
                ...
                <LiquidGlassCard className="feature-card">
                  ...
                  <div>
                    <h3 className="font-semibold text-base text-fd-foreground mb-1.5">
                      {isKm
                        ? 'ភាពបត់បែនបែប Headless ជាមួយរចនាប័ទ្មស្រាប់'
                        : 'Headless flexibility, styled convenience'}
                    </h3>
                    <p className="text-sm text-fd-muted-foreground leading-relaxed">
                      {isKm
                        ? 'បញ្ចេញផលិតផលបានរហ័សជាមួយទម្រង់លំនាំដើមដ៏ស្អាតបាត។ សមាសភាគនីមួយៗត្រូវបានរចនាឡើងដើម្បីងាយស្រួលកែច្នៃបន្ថែម ឱ្យត្រូវនឹងអត្តសញ្ញាណម៉ាករបស់អ្នក។'
                        : 'Ship fast with clean defaults. Every component is designed to be effortlessly overridden to match your brand.'}
                    </p>
                  </div>
                </LiquidGlassCard>
                ...
                <LiquidGlassCard className="feature-card">
                  ...
                  <div>
                    <h3 className="font-semibold text-base text-fd-foreground mb-1.5">
                      {isKm
                        ? 'ឆ្លងកាត់ការប្រើប្រាស់ជាក់ស្ដែងលើ Production'
                        : 'Production tested'}
                    </h3>
                    <p className="text-sm text-fd-muted-foreground leading-relaxed">
                      {isKm ? (
                        <>
                          ...
                          ផ្ទាល់។ សមាសភាគនីមួយៗសុទ្ធតែបានឆ្លងកាត់ការសាកល្បង
                          និងប្រើប្រាស់ជាប្រចាំថ្ងៃក្នុងប្រព័ន្ធផលិតកម្មពិតប្រាកដ។
                        </>
                      ) : (
                        <>
                          Extracted from the{' '}
